...
//
// Recursive helper: build a tree from index entries that belong to the given prefix.
// prefix: directory prefix (e.g., "src/") or "" for root. depth is for reference.
// entries: array of IndexEntry pointers for entries in this directory and below.
